...
public class CRUD {
    ...
    public Note addNote(Note note) {
        ...
        contentValues.put(database.TITLE, note.getTitle());
    ...
    public List<Note> getAllNotes() {
        ...
        if (cursor.getCount() > 0) {
            while (cursor.moveToNext()) {
                ...
                note.setTitle(cursor.getString(cursor.getColumnIndex(database.TITLE)));
    ...
    public int updateNote(Note note) {
        ...
        values.put(database.TITLE, note.getTitle());
